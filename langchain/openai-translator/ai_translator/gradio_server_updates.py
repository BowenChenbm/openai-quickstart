...
def launch_gradio():
    ...
    iface = gr.Interface(
        ...
        inputs=[
            ...
            gr.Textbox(lines=1, label="源语言（默认：英文）", placeholder="English", value="English"),
            gr.Textbox(lines=1, label="目标语言（默认：中文）", placeholder="Chinese", value="Chinese")
        ],
